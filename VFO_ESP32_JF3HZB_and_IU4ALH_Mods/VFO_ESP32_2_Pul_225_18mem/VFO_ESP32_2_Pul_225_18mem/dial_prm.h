...
//ダイアル半径------------------------------------------------------------------
int D_R = 160;   //Dial radius 160 (if 45000, Linear scale)

//メイン，サブダイアルの間隔----------------------------------------------------
int Dial_space = 40;   // Space bitween Main and Sub Dial 40
...
//目盛り・数字間のスペース------------------------------------------------------
int TNCL_main = 15;  // Space bitween Number and Tick (Main) 13
int TNCL = 18;      // Space bitween Number and Tick (Sub)16

// 指針長さ，幅-----------------------------------------------------------------
int DP_len = 90;   // Length of Dial pointer 90
int DP_width = 2;  // Width of Dial pointer   1
int DP_pos = 2;   // Position of Dial pointer 12
...
// main目盛
unsigned long cl_TICK_main = 0x00FF00;  // Main Tick 0x00FF00 verde
// main数字
unsigned long cl_NUM_main = 0xFFFFFF;   //Main Number
// sub目盛
unsigned long cl_TICK = 0x00b0FF;  // Sub Tick 0x00FFFF 
// sub数字
