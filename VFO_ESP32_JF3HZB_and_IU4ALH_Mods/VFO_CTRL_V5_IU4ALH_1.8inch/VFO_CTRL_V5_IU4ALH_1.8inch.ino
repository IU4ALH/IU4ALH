...
--------------------------------------------------------*/
  ...
  int32_t offset_frq = 19000000;    // Offset Frequency[Hz]in + o in - per oscillatore locale LO
  int32_t    car_frq = 19000000;   // 19000000 frequenza BFO  calcolare + o - 1500 Hz per usb o lsb  // Carrier Frequency[Hz]
...
// Read data from eeprom
  ...
  if(readParam!=0) { frq=readParam; } 
    ...
    sprintf(str, "   - IU4ALH -"); disp_str8(str,30, 5, 0xffd080);
    trans65k();
    f_redraw=1;
    delay(1500); 
    init_Dial();
