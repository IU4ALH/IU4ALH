...
int32_t offset_frq = 0000000;  // Offset Frequency[Hz]
...
-----------------------------------------------------------*/
uint32_t vth=20;   	  // Velocity threshold for acceleration
float Racc=100.0;     // Rate of acceleration
float Rdec=1.0;       // Rate of deceleration
float MaxL=10000.0;	  // Max Step[Hz] = freq_step + Racc*MaxL*MaxL
