//  V5.0b    02-03-2022 -  MW and LW indicator for MW and LW Bands in AM mode
...
Step sp[] = {
  { 1 , 10   ,Xfstep, 200, Yfstep, 50,  0},
  { 5 ,  1   ,Xfstep, 200, Yfstep, 50, 50},
  { 9 ,  0   ,Xfstep, 200, Yfstep, 50, 100},
...
//=======================================================================================
  ...
  if (currentMode != FM) {
    ...
    if ((rssi > 84) and (rssi <= 94)) spoint = 250 + (rssi - 84) * 2;  // S9 +50  //188 - 194
 ...
 //   if  (rssi > 95)                   spoint = 208;                    // 208 per >S9 +60
  ...
  else
  {
    ...
    if ((rssi > 64) and (rssi <= 74)) spoint = 250 + (rssi - 64) * 2;  // S9 +50  //188 - 194
